...
/**
 *	Class to generate the supplier orders with the crabettc model
 */
class pdf_crabettc extends ModelePDFSuppliersOrders
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "crabettc";
		$this->description = $langs->trans('SuppliersCommandModelcrabettc');
