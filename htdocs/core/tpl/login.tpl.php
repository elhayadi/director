...
<!-- Title with version -->
<div class="login_table_title center" title="<?php echo dol_escape_htmltag('Tawori V1'); ?>">
<?php
if ($disablenofollow) {
	echo '<a class="login_table_title" href="https://tawori.azmza.info/" target="_blank">';
}
echo dol_escape_htmltag('Tawori V1');
if ($disablenofollow) {
	echo '</a>';
}
?>
