...
?>
	...
	$coldisplay++;
	print '<td class="right"><input type="text" class="flat right" size="5" id="price_ht" name="price_ht" value="'.(isset($line->pu_ht) ?price($line->pu_ht, 0, '', 0) : price($line->pu_ttc, 0, '', 0)).'"';
	if ($situationinvoicelinewithparent) {
		print ' readonly';
	}
	print '></td>';
